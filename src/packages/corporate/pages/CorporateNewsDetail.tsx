    ...
    <article>
      ...
      <header className="container-page max-w-3xl py-8 text-center">
        <div className="flex items-center justify-center gap-3 text-xs text-ink-subtle">
          <span className="badge-accent">{article.tag}</span><span>{formatDay(article.publishedAt)}</span>
        </div>
      ...
      <div className="container-page max-w-4xl"><Photo name={article.photo} alt={article.title} className="aspect-[16/9] ring-soft" /></div>
